        ...
        <ion-content :fullscreen="true">
            <div id="container">
                ...
                <ion-text style="margin-bottom: 20px; text-align: center;">
                    <h1 class="maroon-text">Pahlawan Kekaisaran Mulan</h1>
                    <h4 class="maroon-text">by Nabilla Tsani Ayasi</h4>
                </ion-text>
...
/* Menambahkan kelas untuk warna teks merah maroon dan bold */
.maroon-text {
